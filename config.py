...
FIELD_WIDTH = 800
FIELD_HEIGHT = 400
MENU_LOGO_IMAGE_PATH = "assert/image/haxball-big-min.png"
ITACHI_FRAME_DIR = "assert/extracted_frames/itachi_skill"
ITACHI_FRAME_ALPHA = 82
ITACHI_FRAME_DURATION = 3.0
